...
function getDashboard(lang, aiSec, tools) {
  ...
  return `{
    ...
    tools: {
      ...
      diagnosis: { name: "${tools.diagnosis}", badge: "FREE" },
      whatsapp: { name: "${tools.whatsapp}", badge: "FREE" },
      seo: { name: "${tools.seo}", badge: "FREE" },
      ad_copy: { name: "${tools.ad_copy}", badge: "FREE" },
      video: { name: "${tools.video}", badge: "FREE" }
    }
  }`;
}
