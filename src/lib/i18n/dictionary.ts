  ...
  ur: {
    ...
    onboarding: {
      ...
      contract: {
        ...
        clauses: {
          commission: { title: "1. پلیٹ فارم سروس فیس اور گروتھ کے مراعات", body: "ServiceHub کامیاب بکنگ پر 8 فیصد کی مسابقتی پلیٹ فارم تک رسائی کی فیس لاگو کرتا ہے۔ فیس حتمی ادائیگی سے خود بخود کاٹ لی جاتی ہے۔" },
