  ...
  ur: {
    ...
    onboarding: {
      ...
      contract: {
        ...
        clauses: {
          commission: { title: "1. پلیٹ فارم سروس فیس اور گروتھ کے مراعات", body: "ServiceHub کامیاب بکنگ پر مزدوری کی لاگت پر 8 فیصد کی مسابقتی پلیٹ فارم تک رسائی کی فیس لاگو کرتا ہے۔ کوئی اور پوشیدہ چارجز نہیں ہیں، اور مواد کی قیمتوں پر کوئی پلیٹ فارم فیس نہیں لی جاتی ہے۔ ہمارا AI سسٹم قیمتوں کی انصاف پسندی کا مسلسل جائزہ لیتا ہے تاکہ یہ یقینی بنایا جا سکے کہ تمام مرچنٹ چارجز مارکیٹ کے مطابق ہیں۔ فیس حتمی ادائیگی سے خود بخود کاٹ لی جاتی ہے۔" },
