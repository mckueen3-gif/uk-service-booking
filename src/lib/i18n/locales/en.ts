...
export const en: any = {
  ...
  booking_actions: {
    ...
    rejectTitle: "Reject",
    confirmAlert: "Are you sure you want to ACCEPT this booking?",
    rejectAlert: "Are you sure you want to REJECT this booking?",
    errorUpdate: "Update failed",
  },
  review_system: {
    writeReview: "Write Review",
    modalTitle: "Rate Service",
  ...
  merchant: {
    ...
    dashboard: {
      ...
      verification: {
        ...
        dropzoneDesc: "Supports JPG, PNG, PDF (Max 10MB)",
      ...
      variations: { 
        ...
        typeLabel: "Item Type",
        partType: "Physical Part",
        laborType: "Labor Hour",
        partNote: "* Parts carry 0% platform commission.",
        laborNote: "* Additional labor hours carry standard commission.",
        descLabel: "Description",
        descPlaceholder: "e.g. Front Brake Discs (Pair)",
        amountLabel: "Amount (£)",
        submitting: "Adding...",
        ...
        pendingStatus: "Awaiting Action (Pending)",
        proofLabel: "Expert mandatory evidence description:",
        authorizedAmountLabel: "Authorized amount:",
        processingAuth: "Processing payment & authorization...",
        approveBtn: "💳 Approve & Escrow authorized amount",
      ...
      merchant_wallet: {
        ...
        pending: "Settling / Cooling-off Period",
        escrow: "Held in Escrow",
        settling: "Assets Pending Settlement",
        banking: {
          title: "Bank Details",
          encrypted: "Encrypted Transmission",
          sortCode: "Sort Code (6 digits)",
        ...
        terms: {
          ...
          fee: "Management Fee",
          rights: "Expert Rights & Fee Explanation",
          rules: [
      ...
      merchant_availability: {
        ...
        subtitle: "Set your service hours and daily booking limits",
        save: "Save Changes",
        saving: "Saving...",
        saved: "Availability settings saved successfully!",
        failed: "Save failed, please try again.",
        closed: "Closed",
        start: "START",
        end: "END",
        openBtn: "Open Service",
        closeBtn: "Pause Service",
        settings: {
    ...
    customer_dashboard: {
      ...
      quickLinks: {
        ...
        garage: "My Garage",
        garageDesc: "Manage vehicle info and maintenance logs",
        properties: "My Properties",
        propertiesDesc: "View property details and related bookings",
      },
      referral: {
        success: "Referral code claimed successfully!",
        failed: "Claim failed",
      ...
      stats: {
        referralCredits: "Referral Rewards",
      },
    },
    rewards_hub: {
      balance: "AVAILABLE CREDITS",
      subtitle: "Manage your reward points, vouchers, and referral program.",
      disclaimer: "VOUCHER CREDIT ONLY • NO CASH WITHDRAWAL",
      status: "PEARL GOLD STATUS ACTIVE",
      ...
      redeeming: "Redeeming...",
      redeemSuccess: "Redeemed £{value} credits successfully!",
      redeemFailed: "Redemption failed",
      placeholderCode: "e.g. SAVE20, UKPROMO...",
      history: {
      ...
      marketplace: {
        confirmRedeem: "Are you sure you want to redeem a £10 {brand} voucher?",
        processing: "Processing...",
        success: "Success! Your {brand} voucher will be sent within 24 hours.",
        failed: "Redemption failed",
        lastSynced: "Last synced:",
        aiMonitoring: "(AI Intelligent Monitoring Active)",
        syncing: "AI Syncing... (Catalog Syncing)",
        syncSuccess: "✅ Voucher database sync complete!",
