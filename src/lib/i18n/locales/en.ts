...
export const en: Dictionary = {
  ...
  admin: {
    ...
    bookings: { 
      ...
      sub: "Central Booking Registry & Monitor", 
    ...
    verifications: { 
      title: "Specialist Verifications", 
      sub: "Identity & Document Audit", 
      ...
      idNumber: "ID Number (AI Extracted)",
  ...
  auth: {
    ...
    register: {
      ...
      subtitle: "Join the elite ConciergeAI network and start your journey.", 
      ...
      signIn: "Log in here", 
      roles: { customer: "Customer (Find Services)", merchant: "Specialist (Provide Services)" }
    },
    forgotPassword: {
      ...
      successDetail: "A secure reset link has been sent to {email}. Please check your inbox."
    },
    resetPassword: {
      ...
      notMatch: "Passwords do not match. Try again.",
      error: "System error. Please contact support.",
      successDetail: "Your password has been updated. Redirecting to login page...",
      invalidTokenDetail: "The provided reset link is either expired or invalid.",
      requestNewLink: "Request New Link"
    },
    errors: {
      missingFields: "Please fill in all required fields.",
      passwordTooShort: "Password must be at least 6 characters.",
      emailExists: "This email address is already registered in our system.",
      invalidCredentials: "Login failed. Please check your information.",
      serverError: "Internal system error. Please try again later.",
      resetFailed: "Failed to process your request.",
