...
export const hi: Dictionary = {
  ...
  home: {
    ...
    recommendationResults: {
      trendingTitle: "रुझान",
      topRatedTitle: "टॉप रेटेड",
      ukWideTitle: "यूके के विशिष्ट",
      professionalTitle: "प्रमाणित पेशेवर",
      homeRepair: "होम रिपेयर",
      deepCleaning: "डीप क्लीनिंग",
      accounting: "अकाउंटिंग",
      autoRepair: "ऑटो रिपेयर",
      homeSub: "भरोसेमंद मरम्मत विशेषज्ञ",
      cleanSub: "पेशेवर सफाई सेवाएं",
      accountSub: "प्रमाणित कर सलाहकार",
      autoSub: "विशेषज्ञ यांत्रिक सेवाएं",
      assetMatch: "AI एसेट मैच",
  ...
  onboarding: {
    hero: { title: "ConciergeAI के साथ अपना व्यवसाय बढ़ाएं", subtitle: "यूके के प्रमाणित सेवा पेशेवरों के सबसे विशिष्ट नेटवर्क में शामिल हों।" },
