...
export const zhTW: Dictionary = {
  ...
  auth: {
    ...
    register: {
      ...
      searchAddressPlaceholder: "輸入郵政編碼 (例如: SW1A 1AA)",
      ...
      navToLogin: "已有帳號？",
      signIn: "立即登入",
      merchantDisclaimer: "【收費說明】教育及補習老師免收平台手續費（100% 收入保障，平台費由學生外加支付）。其他專業行業（如水電、裝修等）平台由報價中扣除 9% 佣金。"
    }
  },
  onboarding: {
    hero: {
  ...
  merchant_public: {
    ...
    write_review: "撰寫評價",
    review_summary_title: "AI 智能評價分析",
    review_summary_content: "客戶一致讚賞工作的高品質與高效率，並特別指出良好的溝通與準時度，同時在完工後總會保持場地整潔。",
    review_summary_note: "✦ AI 根據客戶評價自動生成。ConciergeAI 不對摘要內容負責。",
    no_reviews: "尚無評價",
