...
export const zhTW: LocaleDictionary = {
  ...
  merchant: {
    ...
    expertTitle: "精英專家",
    welcome: "歡迎回來，{name}",
    quick_links_hint: "專業成長的戰略快捷方式",
    elite_ai: {
      title: "精英 AI 與 影片",
      video_label: "介紹影片 (YouTube)",
      video_placeholder: "https://youtube.com/watch?v=...",
      knowledge_label: "AI 專家知識庫",
      knowledge_placeholder: "在此處深度加載您的專業知識、服務細微差別和技術標準。這些數據將保持私密，並驅動您的專屬 AI 助手以精準處理技術線索。",
      save_button: "校準專家個人資料"
    },
    pricing: {
      title: "AI 價格脈搏",
      status: "定價健康度",
      optimal: "最佳",
      message: "檢測到市場校準的費用。您目前的費率符合高信任度精英基準。",
      trend: "市場平衡"
    },
    notifications: {
      notifyExpertWhatsApp: "透過 WhatsApp 通知專家",
      notifyExpertWhatsAppDesc: "建議使用以獲得更快回覆",
      bookingAlertEmailSubject: "【新訂單】需要處理：客戶已預約您的服務！",
      expertWhatsAppMsg: "您好 {merchantName}，我剛在 ConciergeAI 預約了您的「{serviceName}」，日期為 {date}。請在您的控制台中確認！預約 ID：#{bookingId}",
    },
    manageServices: "管理服務",
    stats: {
      totalBookings: "總預約數",
    ...
    toolkit: {
      ...
      privacy: {
        title: "精英隱私架構",
        desc: "ConciergeAI 僅在您啟用這些模組時才激活 AI 專業上下文。您的內部業務邏輯始終保持加密和隔離。",
      },
      modules: {
        aura_secretary: {
          title: "Aura AI 秘書",
          desc: "利用您的業務背景實現自動化客戶支援和主動成交。",
          impact: "+15% 預約轉化率"
        },
        promotion_hub: {
          title: "促銷中心",
          desc: "創建優惠券和折扣，讓 Aura 在溝通中提供給客戶以促成交易。",
          impact: "自定義收入增長"
        },
        accounting_ledger: {
          title: "分類帳與稅務審計",
        ...
        social_toolkit: {
          title: "社群媒體工具箱",
          desc: "生成由您的業務 DNA 驅動的病毒式社群貼文和標題。",
          impact: "一鍵品牌增長",
          modes: {
            label: "增長策略",
            viral: "病毒式爆紅",
          ...
          reviews: {
            title: "評論轉貼文 AI",
            subtitle: "選擇一個 5 星評論，將其轉化為病毒式行銷資產。"
          },
          preview: {
            title: "貼文預覽",
            expertTip: "專家提示",
            copyBtn: "複製標題",
            copied: "已複製！",
            shareHint: "將此分享到您的限時動態或 WhatsApp 以吸引新客戶。"
          }
        },
        ai_diagnosis: {
          title: "AI 智能診斷",
        ...
        seo_expert: {
          title: "SEO 專家檔案優化",
          desc: "提升 Google 排名並優化您的個人檔案元數據。",
          impact: "自然流量 x2"
        },
        audit_vault: {
          title: "審計保險庫",
          desc: "專業追蹤您的專家記錄和稅務就緒導出。",
          impact: "HMRC 合規邏輯"
        }
      },
      diagnosis: {
      ...
      whatsapp: {
        title: "WhatsApp 實時對接",
        desc: "即時獲獲取新訂單與客戶諮詢通知",
        gateway_active: "網關已激活",
        init_connection: "初始化連接",
        active_desc: "您的 WhatsApp 節點已成功連結。您現在將收到每個高意向潛在客戶的即時推送通知。",
        init_desc: "連結您的業務 WhatsApp 帳戶，直接在手機上接收實時更新和客戶諮詢通知。",
        syncing: "正在同步...",
        link_now: "立即連結 WhatsApp",
        secured: "連接已安全",
        features: {
          alerts: { title: "即時潛在客戶警報", desc: "在客戶對您的服務表示感興趣的瞬間收到通知。" },
          mobile: { title: "行動管理", desc: "無需登入儀表板，直接透過 WhatsApp 回覆諮詢。" },
          sync: { title: "AI 回覆同步", desc: "Aura AI 可以為您起草回覆，供您一鍵審查並發送。" }
        },
        elite_title: "精英專家集成",
        elite_desc: "WhatsApp Connect 是已驗證 ConciergeAI 專家的獨家功能。它使您能夠保持 100% 的響應率，這將顯著提升您在我們搜尋算法中的排名。",
        view_docs: "查看文檔"
      },
      seo: {
        title: "SEO 專家檔案優化",
        desc: "提升 Google 排名並優化元數據",
        hero_title: "排名更高，增長更快。",
        hero_desc: "我們的 AI SEO 專家會分析您的檔案和服務，確保它們針對 Google 搜尋和 ConciergeAI 的內部排名算法進行了全面優化。",
        analyzing: "正在分析檔案數據...",
        run_audit: "運行 AI SEO 審計",
        score_title: "搜尋可見度評分",
        scores: {
          completion: "檔案完整度",
          density: "關鍵字密度",
        ...
        auto_title: "AI 自動校準",
        auto_desc: "讓我們的 AI 自動更新您的檔案元數據，以匹配您所在行業的當前搜尋趨勢。",
        apply_auto: "應用自動優化",
        global_title: "全球觸達",
