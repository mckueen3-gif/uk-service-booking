...
export const zhTW: Dictionary = {
  ...
  admin: {
    ...
    header: { internal: "內部管理系統", operations: "中央營運指揮", node: "活動執行節點" },
    stats: {
      gmv: "總交易額 (30d)",
      netRevenue: "平台淨營收",
      bookings: "已完成訂單",
  ...
  auth: {
    login: {
      title: "帳戶登入",
      subtitle: "登入您的 ConciergeAI 帳戶以管理服務。",
      emailLabel: "電子郵件地址",
      ...
      or: "或",
      google: "透過 Google 登入",
      navToRegister: "還沒有帳號嗎？",
      createAccount: "註冊成為成員",
      error: "登入失敗，請檢查您的帳號密碼。",
      success: "登入成功，正在導向控制面板。"
    },
    register: {
      title: "註冊新帳戶",
      subtitle: "加入 ConciergeAI 平台並開始使用。",
      firstNameLabel: "名字",
      lastNameLabel: "姓氏",
      emailLabel: "電子郵件地址",
      emailPlaceholder: "您的電子郵件",
    ...
    forgotPassword: {
      ...
      loading: "正在處理...",
      back: "返回登入頁面",
      success: "重設連結已成功發送到您的信箱。",
      error: "無法發送郵件，請重新檢查地址。",
      successDetail: "我們已將重設密碼連結發送至 {email}，請查收。"
    },
    resetPassword: {
      title: "重設密碼",
      subtitle: "請在下方設定您的新密碼。",
      passwordLabel: "新密碼",
      ...
      notMatch: "密碼不一致，請重新檢查。",
      error: "更新失敗，請聯絡客服支援。",
      successDetail: "密碼已更新。正在導向登入頁面...",
      invalidTokenDetail: "重設連結無效或已過期。",
      requestNewLink: "重新申請重設連結"
    },
    errors: {
      missingFields: "請填寫所有必要欄位。",
      passwordTooShort: "密碼長度至少需 6 個字元。",
      emailExists: "此電子郵件地址已被註冊。",
      invalidCredentials: "登入失敗，請檢查您的憑據。",
      serverError: "系統發生內部錯誤，請稍後再試。",
      resetFailed: "處理重設請求失敗。",
      invalidReset: "重設連結無效或已過期。"
    },
    loading: {
      preparing: "正在準備存取...",
      initializing: "系統初始化中..."
