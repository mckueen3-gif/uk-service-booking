...
export const ko: Dictionary = {
  ...
  onboarding: {
    ...
    contract: { title: "표준 서비스 계약", scrollingNotice: "약관에 동의하려면 끝까지 스क्रोल해 주세요.", agree: "ServiceHub 마스터 계약을 읽었으며 이에 동의합니다.", clauses: { platform_fee: { title: "1. 플랫폼 서비스 수수료", body: "ServiceHub는 예약 성공 시 9%의 수수료를 부과합니다." }, payments: { title: "2. 에스크로 및 지급", body: "고객 결제는 안전한 에스크로에 보관됩니다. 고객이 작업 완료를 확인한 후 48시간 후에 지급이 활성화됩니다." }, conduct: { title: "3. 전문성 표준", body: "전문가는 최소 4.0점의 평점을 유지해야 합니다. 영국 안전 기준을 충족하지 못할 경우 즉시 계정이 정지될 수 있습니다." } } },
