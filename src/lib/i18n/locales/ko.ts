...
export const ko: Dictionary = {
  ...
  admin: {
    sidebar: { 
      ...
      analytics: "데이터 분석", 
      bookings: "예약 관리 리스트", 
      verifications: "전문가 신원 심사", 
      disputes: "분쟁 및 중재 관리", 
      merchants: "인증 전문가 디렉토리", 
      payouts: "재무 결제 센터", 
      users: "고객 디렉토리", 
      settings: "시스템 설정", 
      terminal: "관리자 터미널" 
    },
    header: { internal: "내부 관리 시스템", operations: "중앙 운영 센터", node: "활성 서버 노드" },
  ...
  auth: {
    login: {
      title: "계정 로그인",
      subtitle: "ConciergeAI 계정에 로그인하여 서비스를 관리하세요.",
      emailLabel: "이메일 주소",
      ...
      or: "또는",
      google: "Google로 로그인",
      navToRegister: "아직 계정이 없으신가요?",
      createAccount: "지금 등록하기",
      error: "로그인에 실패했습니다. 이메일 또는 비밀번호를 확인하세요.",
      success: "로그인 성공! 대시보드로 이동합니다."
    },
    register: {
      title: "새 계정 만들기",
      subtitle: "ConciergeAI 엘리트 네트워크에 참여하세요.",
      firstNameLabel: "이름",
      lastNameLabel: "성",
      emailLabel: "이메일 주소",
      emailPlaceholder: "example@concierge.ai",
      ...
      signIn: "로그인하기",
      roles: { customer: "고객 (서비스 찾기)", merchant: "전문가 (서비스 제공)" }
    },
    forgotPassword: {
      title: "비밀번호 찾기",
      subtitle: "등록된 이메일을 입력하여 재설정 링크를 받으세요.",
      emailLabel: "이메일 주소",
      emailPlaceholder: "example@concierge.ai",
      submit: "재설정 링크 보내기",
      loading: "처리 중...",
      ...
      error: "이메일을 보낼 수 없습니다. 주소를 확인해 주세요.",
      successDetail: "{email}로 보안 재설정 링크를 보냈습니다. 이메일을 확인해 주세요."
    },
    resetPassword: {
      title: "비밀번호 재설정",
      ...
      invalidToken: "링크가 만료되었거나 무결성이 훼손되었습니다.",
      notMatch: "비밀번호가 일치하지 않습니다. 다시 확인해 주세요.",
      error: "시스템 오류가 발생했습니다. 고객 지원팀에 문의하세요.",
      successDetail: "비밀번호가 업데이트되었습니다. 로그인 페이지로 이동합니다...",
      invalidTokenDetail: "제공된 재설정 링크가 만료되었거나 유효하지 않습니다.",
      requestNewLink: "재설정 링크 다시 요청하기"
    },
    errors: {
      missingFields: "필수 항목을 모두 입력해 주세요.",
      passwordTooShort: "비밀번호는 최소 6자 이상이어야 합니다.",
      emailExists: "이 이메일 주소는 이미 등록되어 있습니다.",
      invalidCredentials: "로그인에 실패했습니다. 정보를 다시 확인하세요.",
      serverError: "시스템 내부 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.",
      resetFailed: "요청 처리에 실패했습니다.",
      invalidReset: "유효하지 않거나 만료된 링크입니다."
    },
    loading: {
      preparing: "로그인 준비 중...",
