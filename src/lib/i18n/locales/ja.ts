...
export const ja: any = {
  ...
  landing_pages: {
    plumbing: {
      hero: {
        ...
        title2: "配管と動力",
        subtitle:
          "精密な配管、電気、ハードウェアの統合のために、英国の認定スペシャリストとつながりましょう。品質保証のためにAIが監視しています。",
      ...
      sub_categories: {
        pipe: {
          title: "パイプ修理",
          desc: "緊急の漏水検知と精密なハードウェア交換。",
        },
        wiring: {
          title: "システム配線",
          desc: "プロフェッショナルな電気校正とノードの統合。",
        },
        appliance: {
          title: "機器の統合",
          desc: "衛生および調理用ハードウェアの配置とテスト。",
        },
        boiler: {
          title: "ボイラー監査",
          desc: "規制に基づく熱管理とパフォーマンス診断。",
        },
        switch: {
          title: "スイッチギア",
          desc: "高整合性の電気コンポーネントの交換。",
        },
        smart: {
          title: "スマートオートメーション",
          desc: "メッシュネットワークによるホームオートメーションとセンサーの配置。",
        },
      },
    },
    repairs: {
      ...
      sub_categories: {
        furniture: {
          title: "家具組み立て",
          desc: "複雑なモジュール式ハードウェアの精密な組み立て。",
        },
        structural: {
          title: "構造フィクスチャ",
          desc: "高荷重フィクスチャの取り付けと校正。",
        },
        wall: {
          title: "壁の修復",
          desc: "表面の修理と構造コーティングの復元。",
        },
        mounting: {
          title: "モジュール式取り付け",
          desc: "デジタルおよび物理的なウォールユニットの安全な配置。",
        },
        coating: { title: "コーティング", desc: "美的かつ保護的な表面処理。" },
        tactics: {
          title: "一般的な戦術",
          desc: "汎用的な住宅メンテナンスプロトコル。",
        },
      },
    },
    renovation: {
      ...
      sub_categories: {
        culinary: {
          title: "調理と衛生",
          desc: "フルスタックのキッチンおよびバスルームの再設計。",
        },
        expansion: {
          title: "拡張ユニット",
          desc: "物件の容量を増やすためのロフトおよびモジュールの拡張。",
        },
        layout: {
          title: "空間レイアウト",
          desc: "ホログラフィックデザインと構造の再構成。",
        },
        floor: {
          title: "フロアメッシング",
          desc: "高耐久性の床の配置と仕上げ。",
    ...
    accounting: {
      ...
      sub_categories: {
        income: {
          title: "所得監査",
          desc: "セルフアセスメントと個人所得税の校正。",
        },
        accounts: { title: "年次決算", desc: "法人財務報告と帳簿の締め切り。" },
        tax: { title: "税務申告", desc: "HMRC対応の税務準備と送信。" },
        payroll: {
          title: "給与メッシング",
          desc: "効率的な人的資本支払いシステム。",
        },
        xero: {
          title: "Xero最適化",
          desc: "クラウド会計の統合とトレーニング。",
        },
        fiscal: {
          title: "財務分析",
          desc: "詳細なビジネスパフォーマンスのテレメトリ。",
        },
      },
    },
    legal: {
      hero: {
        ...
        title2: "法的枠組み",
        subtitle:
          "ビザプロトコル、契約書の作成、および紛争解決支援のために、英国認定の法務エキスパートとつながりましょう。",
      ...
      sub_categories: {
        drafting: {
          title: "SLA作成",
          desc: "高精度な契約書および合意書の合成。",
        },
        visa: {
          title: "ビザ校正",
          desc: "英国のビザおよび移民プロトコルの支援。",
        },
        property: {
          title: "不動産枠組み",
          desc: "譲渡および不動産の法的論理。",
        ...
        arbitration: {
          title: "仲裁",
          desc: "中立的な紛争解決とメディエーションプロトコル。",
        },
        law: {
          title: "マーケットプレイス法",
          desc: "企業および商業ガバナンスの支援。",
        },
    ...
    cleaning: {
      ...
      sub_categories: {
        hygiene: {
          title: "定期的な衛生",
          desc: "標準化された一貫した物件の衛生管理。",
        },
        tenancy: {
          title: "退去時清掃",
          desc: "居住者の交代に伴う徹底的な清掃。",
        },
        textile: {
          title: "テキスタイルクリーニング",
          desc: "プロフェッショナルなカーペットおよび家具の復元。",
        },
        aperture: {
          title: "ガラスクリーニング",
          desc: "高所の窓およびガラスの除菌プロトコル。",
        },
        office: { title: "オフィス除菌", desc: "商業作業エリアの衛生管理。" },
        bio: {
          title: "バイオセキュリティ",
          desc: "除染およびクリニックグレードのクリーニング。",
        },
      },
    },
    car: {
      hero: {
        ...
        title2: "エンジニアリング",
        subtitle:
          "英国のマスターメカニックと共にモバイルハードウェアをメンテナンスしましょう。オンサイト診断と高性能な整備を提供します。",
      ...
      sub_categories: {
        engine: {
          title: "エンジン診断",
          desc: "高度な故障診断とパフォーマンスチューニング。",
        },
        brakes: {
          title: "ブレーキとクラッチ",
          desc: "安全上重要な摩擦システムの校正。",
        },
    ...
    commercial: {
      hero: {
        ...
        title2: "を強化する",
        subtitle:
          "英国の商業空間のためのエンドツーエンドのインフラサポート。店舗内装、オフィス移転、産業メンテナンス。",
      ...
      sub_categories: {
        fitting: {
          title: "ユニットフィッティング",
          desc: "小売および商業空間のインテリアエンジニアリング。",
        },
        relocation: {
          title: "ノードの移転",
          desc: "シームレスなオフィスおよび産業移転プロトコル。",
        },
        industrial: { title: "産業用電力", desc: "高電圧電力網の配置。" },
        fire: {
          title: "防火セキュリティ",
          desc: "規制に基づく安全および検知メッシュシステム。",
        },
        mesh: {
          title: "ITメッシュ",
          desc: "エンタープライズネットワーキングとデータケーブリング。",
        },
  ...
  hero: {
    ...
    badge: "英国 No.1 サービス予約プラットフォーム",
  },
  faq: {
    title: "よくある質問",
    subtitle:
      "英国サービス予約プラットフォームについて知っておくべきことすべて。",
    categories: {
      payments: "お支払い",
      disputes: "トラブル解決",
      bookings: "予約・管理",
    ...
    aura: {
      title: "Aura AI アシスタント",
      subtitle:
        "すぐにお手伝いが必要ですか？Auraに相談してアドバイスをもらいましょう。",
      cta: "Auraと話す",
    },
    questions: {
      payments: [
        {
          q: "サービス料金はどのように支払いますか？",
          a: "Stripeを通じて安全に処理されます。作業の完了を確認するまで、料金はエスクローアカウントで保護されます。",
        },
        {
          q: "隠れた手数料はありますか？",
          a: "いいえ。プラットフォームは顧客からサービス手数料を徴収しません。支払うのは技術者の工賃と承認された材料費のみです。",
        },
      ],
      disputes: [
        {
          q: "作業内容に満足できない場合はどうすればよいですか？",
          a: "当社のAI仲裁者が、当初の作業範囲に基づいて写真をレビューし、公正な解決を保証します。",
        },
        {
          q: "返金はどのようにリクエストしますか？",
          a: "専門家が合意された条件を満たさなかった場合、ダッシュボードからトラブル解決（糾紛）を申し立てることができます。",
        },
      ],
      bookings: [
        {
          q: "予約のキャンセルはできますか？",
          a: "はい。予約時間の24時間前までであれば、全額返金のためのキャンセルが可能です。",
        },
        {
          q: "専門家と直接連絡を取るには？",
          a: "予約が確定すると、専用のセキュアチャットチャンネルが利用可能になります。",
        },
      ],
    },
  },
  aura: {
    welcome:
      "こんにちは！私はAura、あなたの英国サービスコーディネーターです。本日はどのようなお手伝いが必要ですか？",
    offline: "オフライン",
    ready: "オンライン - 準備完了",
    placeholder: "Auraに何でも聞いてください...",
    error:
      "申し訳ありません。現在接続に問題が発生しています。後でもう一度お試しください。",
  ...
  search: {
    ...
    sortDistance: "距離順",
    sortPrice: "価格：安い順",
    foundCount: "{{count}}件の専門家が見つかりました",
    searching: "専門家を探しています...",
    noResults: "条件に一致する専門家は見つかりませんでした",
    noResultsHint: "フィルターを調整するか、別のエリアで検索してみてください。",
    clearFilters: "クリア",
    basePrice: "予想開始価格",
    viewDetails: "詳細を見る",
    listView: "リスト表示",
    mapView: "マップ表示",
    searchThisArea: "このエリアで検索",
    verified: "認定済み",
    insured: "保険加入済み",
  ...
  booking: {
    ...
    titles: {
      details: "ご希望内容をお聞かせください",
      schedule: "日時を選択してください",
      confirm: "予約内容の確認",
      success: "予約が確定しました！",
    },
    labels: {
    ...
    messages: {
      finalizing: "予約を確定しています...",
      wait: "ページを更新しないでください",
      contact24h: "24時間以内に専門家から連絡が入ります。",
      safety: "安全のため、支払いは作業完了までエスクローで保管されます。",
  ...
  merchant: {
    ...
    background: "犯罪歴調査済み",
    portfolio: "実績ポートフォリオ",
    reviewTitle: "カスタマーレビュー",
    realReviews: "認定予約からの本物の口コミ",
    verifiedBooking: "認定済み予約",
    pricingAnalysis: "AI価格分析",
    bookingChannel: "プロ予約チャンネル",
    viewServices: "全サービスを見る",
    guarantee: "サービス保証",
    fastResponse: "スピード対応",
    ...
    manageServices: "サービス管理",
      ...
      wallet: {
        ...
        referralDesc:
          "あなたの専用コードをシェア。友達が最初のサービスを予約すると、2%相当の電子ギフト券が付与されます（スーパーや小売店で使用可能）。",
        historyTitle: "取引履歴",
        ...
        rewards: {
          title: "電子ギフト券に交換",
          subtitle:
            "* 現金引き出し不可。主要小売店（Tesco, Amazonなど）のデジタルギフト券。24時間以内に発行。",
          myVault: "マイクーポン",
          redeemBtn: "申請する",
          ...
          requestSuccess:
            "申請完了！コードを生成しています。後でマイクーポンを確認してください。",
        },
      },
      bookings: {
        title: "最近の予約",
      ...
      modal: {
        ...
        amount: "追加金額 (£)",
        reason: "理由",
        reasonPlaceholder: "例：床下に追加の漏水箇所を発見",
        photo: "証拠写真",
        photoHint: "AI検証に必須です",
        submit: "請求を送信",
        submitting: "アップロード中...",
    ...
    portfolio_mgr: {
      ...
      emptyTitle: "実績なし",
      emptyDesc:
        "過去のプロジェクトの写真を追加して、新しい信頼を築きましょう。",
      modal: {
        title: "実績追加",
        itemTitle: "プロジェクト名",
        itemTitlePlaceholder: "例：ロンドンでのボイラー設置",
        category: "カテゴリー",
        uploadPhoto: "プロジェクト写真をアップロード",
        errorSize: "写真は5MB以下にしてください",
        details: "詳細内容",
        aiBtn: "AIで生成",
        aiGenerating: "作成中...",
        detailsPlaceholder: "行った作業、課題、結果を説明してください。",
        cancel: "キャンセル",
        publish: "実績を公開",
      },
      deleteConfirm: "この実績を削除してもよろしいですか？",
      addError: "追加に失敗しました。",
  ...
  education_sec: {
    ...
    tutorProfile: {
      ...
      portfolio: "合格・成功事例",
      reviews: "生徒の評価",
      availability: "週間スケジュール",
      bookNow: "今すぐ予約",
      aiTrial: "AI診断テスト",
      trialChallenge: "学習診断チャレンジ",
  ...
  home: {
    ...
    recommendation: {
      title1: "あなたへ",
      title2: "おすすめ",
      subtitle: "ニーズと現在地に基づいたトッププロフェッショナル。",
      browse: "すべて見る",
    },
    ...
    aiCTA: {
      badge: "ChatGPT, Gemini & Grok 搭載",
      title1: "不具合の原因がわからない？",
      title2: "即時AI診断を受ける",
      subtitle:
        "問題箇所の写真をアップロード。AIが故障を特定し、費用を見積もり、最適な専門家を数秒で提案します。",
      button: "無料AI診断を開始",
    },
    referralCTA: {
      badge: "紹介報酬",
      title: "2%の受動的報酬を獲得",
      subtitle:
        "友達を紹介して、今後5年間の全予約額からショッピングギフト券として2%の報酬を得ましょう（現金引き出し不可）。",
      button: "報酬プログラムを開始",
      referralLabel: "あなたの紹介コード：",
      voucherDisclaimer:
    ...
    sections: {
      plumbing: {
        title: "配管・テクニカル",
        desc: "緊急の漏水から複雑な配線まで、認定技術者を繋ぎます。",
        items: [
          "漏水修理",
          "電気工事",
          "家電設置",
      ...
      repairs: {
        title: "便利屋・修理",
        desc: "家具の組み立て、壁の補修、鍵の交換など、あらゆる家事代行。",
        items: [
          "家具組み立て",
          "大工仕事",
          "壁の補修",
      ...
      renovation: {
        title: "リフォーム・改築",
        desc: "キッチンの拡張から全面改装まで。透明な進捗管理と品質保証。",
        items: [
          "キッチン・バス",
          "住宅拡張",
          "インテリア",
      ...
      legal: {
        title: "法的アドバイス",
        desc: "ビザ申請、契約書作成など。権利を守る専門家と繋がる。",
        items: [
          "契約書作成",
          "ビザ相談",
          "不動産法",
      ...
      commercial: {
        title: "商用サービス",
        desc: "店舗・オフィス向け。内装工事、移転、電気メンテナンス。",
        items: [
          "店舗内装",
          "オフィス移転",
          "産業用電気",
    ...
    allUK: "全英",
    noProjects: {
      title: "このカテゴリーには実績がありません",
      desc: "あなたの地域のトップスペシャリストを募集中です。",
    },
    reviews: {
      excellent: "素晴らしい",
      basedOn: "に基づき",
    ...
    howItWorks: {
      ...
      step1Title: "AI診断",
      step1Desc:
        "問題をアップロードして、即座に故障箇所を特定し、正確なコスト見積もりを取得します。",
      step2Title: "スマートマッチング",
      step2Desc:
        "当社のネットワークが、特定のケースに合わせて調整された上位1%の専門家を特定します。",
      step3Title: "エスクロー決済",
      step3Desc:
        "支払いは安全なエスクローに保管され、作業の成功を確認した後に実行されます。",
      step4Title: "サービス保証",
      step4Desc:
        "すべてのセッションは品質向上のためにAIで監視され、紛争解決もサポートされます。",
    },
  },
  location: {
    selectCity: "都市を選択",
  ...
  diagnosis: {
    ...
    title2: "一瞬で",
    subtitle:
      "推測はやめましょう。AIが写真を分析し、予約前に技術的な洞察、修理範囲、適正価格をご提案します。",
    features: {
      instant: {
        title: "即時インサイト",
        desc: "電話を待つ必要はありません。アップロード後すぐに技術分析を確認できます。",
      },
      pricing: {
        title: "適正な価格設定",
        desc: "実際のサービスデータに基づき、お住まいの地域の正確な価格帯を算出します。",
      },
      verified: {
        title: "認定された予約",
        desc: "診断後、問題解決に最適なトップ1%の専門家に直接繋がります。",
      },
    },
    cta: "全サービスを見る",
    tool: {
      title: "即時AI診断",
      subtitle:
        "写真をアップロードして、AIに費用と作業範囲を見積もらせましょう。",
      step1: "1. 証拠写真をアップロード",
      step2: "2. カテゴリーを選択",
      step3: "3. 状況説明（任意）",
  ...
  admin: {
    ...
    commissions: {
      title: "手数料設定",
      sub: "収益コントロール",
      plateformFee: "プラットフォーム手数料",
      marketplaceFee: "マーケットプレイス手数料",
      adminControl: "管理者コントロール",
      weightedAvg: "加権平均",
      totalJobs: "総タスク数",
      deliveryVolume: "取引高",
      merchantDetails: "加盟店詳細",
    },
    disputes_mgr: {
      empty: "保留中のトラブルはありません。",
      viewDetails: "レビューする",
      status: { open: "未解決", processing: "処理中", settled: "解決済み" },
    },
    merchants_mgr: {
      empty: "専門家が見つかりません。",
      status: { active: "有効", suspended: "停止中", pending: "審査中" },
    },
    settings_mgr: {
      title: "グローバル階層設定",
