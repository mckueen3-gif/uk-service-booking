...
export const ar: Dictionary = {
  ...
  faq: {
    ...
    questions: {
      payments: [
        ...
        { q: "هل هناك رسوم خفية؟", a: "لا، أنت تدفع السعر الموضح في التقدير. نتقاضى رسوم منصة صغيرة متضمنة في السعر." }
      ],
      disputes: [
  ...
  footer: { 
    ...
    legal: "قانوني", 
    support: "الدعم", 
    rights: "© 2024 UK Service Hub. جميع الحقوق محفوظة.", 
    terms: "شروط الخدمة", 
  ...
  booking: {
    ...
    labels: { date: "التاريخ", time: "الوقت", make: "الماركة", model: "الموديل", address: "العنوان", notes: "ملاحظات", agree: "أوافق على الشروط ورسوم المنصة 2%", summary: "ملخص الدفع", paid: "مدفوع", merchant: "الخبير", service: "الخدمة" },
  ...
  merchant: {
    ...
    dashboard: {
      ...
      wallet: {
        ...
        referralTitle: "رشح صديقاً واحصل على 2% كاش باك",
        referralDesc: "شارك كودك الفريد. ستحصل على 2% كاش باك عندما يحجز صديقك خدمته الأولى.",
        ...
        rewards: {
          title: "تبديل المكافآت",
          subtitle: "* يتطلب مراجعة يدوية. تسلم الأكواد في غضون 24 ساعة.",
          myVault: "محفظتي",
          redeemBtn: "تبديل",
      ...
      tips: { title: "نصائح النمو", growth: "أكمل 5 مهام أخرى لتصل إلى المستوى الذهبي وتنخفض العمولة لـ 7%." },
  ...
  home: {
    hero: { badge: "محترفون محليون معتمدون", title1: "احجز أفضل", title2: "الخبراء المحليين", subtitle: "وصول فوري إلى أفضل 1% من المتخصصين في المملكة المتحدة. جميعهم معتمدون ومؤمن عليهم ومراقبون بواسطة AI.", searchPlaceholder: "أنا أحتاج...", locationPlaceholder: "London, UK", aiMatch: "مطابقة ذكية", searchBtn: "بحث" },
    ...
    aiCTA: { badge: "مدعوم بواسطة GEMINI AI", title1: "لا تعرف ما المشكلة؟", title2: "احصل على تشخيص AI فوري", subtitle: "ارفع صورة للمشكلة. سيتعرف الذكاء الاصطناعي على العطل ويقدر التكلفة ويجد لك الخبير المناسب في ثوانٍ.", button: "ابدأ التشخيص المجاني" },
    referralCTA: { badge: "مكافآت الترشيح", title: "اكسب 2% دخل سلبي", subtitle: "رشح أصدقاءك واحصل على 2% من جميع حجوزاتهم للسنوات الخمس القادمة (حتى 200 جنيه إسترليني لكل صديق).", button: "ابدأ الكسب الآن", referralLabel: "كود الترشيح الخاص بك:" },
