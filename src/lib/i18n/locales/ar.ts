...
export const ar: Dictionary = {
  ...
  aura: {
    welcome: "مرحباً! أنا أورا، منسق الخدمات في المملكة المتحدة. كيف يمكنني مساعدتك اليوم؟",
    offline: "غير متصل",
    ready: "متصل وجاهز للمساعدة",
    placeholder: "اسأل أورا أي شيء...",
    error: "عذراً، أواجه مشكلة في الاتصال الآن. يرجى المحاولة مرة أخرى لاحقاً.",
    footer: "مساعدة الذكاء الاصطناعي الآمنة • إصدار المنصة 1.2",
    suggestions: {
      refund: "كيفية استرداد الأموال؟",
      dispute: "نزاع حول الإصلاح؟",
      warranty: "شروط الضمان",
      booking: "حول الحجز",
      refundQuery: "كيف يمكنني التقدم بطلب لاسترداد الأموال؟ ما هي العملية؟",
      disputeQuery: "ماذا أفعل إذا كان هناك نزاع حول جودة الإصلاح أو السعر؟",
      warrantyQuery: "هل الخدمات التي تقدمها المنصة لها ضمان؟",
      bookingQuery: "كيف يمكنني حجز فني قريب مني؟"
    }
  },
  ...
  admin: {
    sidebar: { 
      ...
      verifications: "تحقق الخبراء", 
      disputes: "النزاعات والتحكيم", 
      merchants: "دليل الخبراء المعتمدين", 
      payouts: "مركز المدفوعات والتسوية", 
      users: "دليل العملاء", 
      settings: "إعدادات النظام", 
      terminal: "لوحة التحكم الإدارية" 
    },
    header: { internal: "إدارة داخلية آمنة", operations: "مركز العمليات المركزية", node: "نقطة الخدمة النشطة" },
  ...
  auth: {
    login: {
      ...
      subtitle: "سجل الدخول إلى حساب ConciergeAI الخاص بك لإدارة خدماتك.",
      ...
      navToRegister: "هل أنت جديد في المنصة؟",
      createAccount: "سجل الآن كعضو",
      error: "فشل تسجيل الدخول. يرجى التحقق من البريد الإلكتروني وكلمة المرور.",
      success: "تم تسجيل الدخول بنجاح. جاري توجيهك إلى لوحة التحكم."
    },
    register: {
      title: "إنشاء حساب جديد",
      subtitle: "انضم إلى شبكة ConciergeAI النخبوية وابدأ رحلتك المهنية.",
      firstNameLabel: "الاسم الأول",
      lastNameLabel: "اسم العائلة",
      emailLabel: "البريد الإلكتروني",
      emailPlaceholder: "example@concierge.ai",
      accountTypeLabel: "نوع الحساب",
      passwordLabel: "تعيين كلمة المرور",
      ...
      navToLogin: "هل لديك حساب بالفعل؟",
      signIn: "سجل الدخول من هنا",
      roles: { customer: "عميل (يبحث عن خدمة)", merchant: "خبير (يقدم خدمة)" }
    },
    forgotPassword: {
      title: "هل نسيت كلمة المرور؟",
      subtitle: "أدخل بريدك الإلكتروني المسجل للحصول على رابط إعادة التعيين.",
      emailLabel: "البريد الإلكتروني",
      emailPlaceholder: "example@concierge.ai",
      ...
      error: "تعذر إرسال البريد. يرجى التأكد من العنوان.",
      successDetail: "تم إرسال رابط إعادة تعيين آمن إلى {email}. يرجى التحقق من بريدك."
    },
    resetPassword: {
      title: "إعادة تعيين كلمة المرور",
      subtitle: "يرجى تعيين كلمة مرور جديدة أدناه.",
      ...
      invalidToken: "الرابط منتهي الصلاحية أو غير صالح.",
      notMatch: "كلمات المرور غير متطابقة. يرجى التأكد.",
      error: "حدث خطأ في النظام. يرجى الاتصال بالدعم.",
      successDetail: "تم تحديث كلمة المرور. جاري توجيهك لصفحة تسجيل الدخول...",
      invalidTokenDetail: "رابط إعادة التعيين المقدم منتهي الصلاحية أو غير صالح.",
      requestNewLink: "طلب رابط جديد"
    },
    errors: {
      missingFields: "يرجى تعبئة جميع الحقول المطلوبة.",
      passwordTooShort: "يجب أن تكون كلمة المرور 6 أحرف على الأقل.",
      emailExists: "هذا البريد الإلكتروني مسجل بالفعل في نظامنا.",
      invalidCredentials: "فشل الدخول. يرجى التحقق من بياناتك.",
      serverError: "حدث خطأ داخلي في النظام. يرجى المحاولة لاحقاً.",
      resetFailed: "فشل في معالجة طلب إعادة التعيين.",
      invalidReset: "رابط إعادة تعيين غير صالح أو منتهي الصلاحية."
    },
    loading: {
      preparing: "جاري تحضير الدخول...",
