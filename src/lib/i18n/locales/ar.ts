...
export const ar: any = {
  ...
  comparison_table: {
    header_features: "مزايا الخدمة",
    header_others: "منصات الحجز القياسية",
    label_legacy: "المنصة القياسية: ",
    ...
    rows: {
      ...
      client_calibre: {
        title: "جودة العملاء",
        others: "سوق عام",
        concierge: "عملاء أكثر تميزاً وجودة عالية"
      },
      earnings_model: {
        title: "نموذج الأرباح",
        others: "دخل لمرة واحدة فقط",
        concierge: "مشاركة أرباح الإحالة (5 سنوات) قسائم نقدية"
      },
      verification: {
        title: "نظام التحقق",
        others: "يدوي / بطيء",
        concierge: "ذكاء اصطناعي ذكي (SMART AI)"
      },
      marketing_support: {
        title: "دعم التسويق",
        others: "يتطلب إنفاق إعلاني",
        concierge: "مطابقة دقيقة تلقائية عادلة على مستوى المنصة (وضع الاستكشاف)"
      },
      communication: {
        title: "رسائل فورية",
        others: "قنوات خارجية (WhatsApp/هاتف) إدارة مشتتة",
        concierge: "مركز دردشة فورية حصري Nexus (مشفر)"
      },
      booking_system: {
        title: "نظام الحجز",
        others: "جدولة يدوية / تضارب المواعيد",
        concierge: "معايرة جدولة أوتوماتيكية بالكامل (جدولة ذكية)"
      },
      toolkit: {
        title: "أدوات تقنية",
        others: "قائمة أساسية فقط",
        concierge: "تشخيص AI مدمج وإدارة الممتلكات"
      },
      data_sovereignty: {
        title: "سيادة البيانات",
        others: "المنصة تملك وتتحكم في بياناتك",
        concierge: "ملفات شخصية احترافية لا مركزية (Smart Bio)"
      },
      growth: {
        title: "النمو المهني",
        others: "لا توجد موارد تدريبية",
        concierge: "قنوات تعليمية وتدريب على المهارات الخبيرة"
      }
    }
  },
  legal: {
    ui: { selectLanguage: "الاتصال العالمي", close: "إكمال البروتوكول" },
  },
  landing_pages: {
    plumbing: {
      hero: {
        badge: "دقة عالية الجودة",
        title1: "هندسة متفوقة",
        title2: "السباكة والطاقة",
        subtitle:
          "تواصل مع خبراء معتمدين في المملكة المتحدة للسباكة الدقيقة والكهرباء وتكامل الأجهزة. مراقبة بواسطة الذكاء الاصطناعي لضمان الجودة.",
      ...
      sub_categories: {
        pipe: {
          ...
          desc: "كشف التسرب في حالات الطوارئ واستبدال الأجهزة بدقة.",
        },
        wiring: {
          title: "إعادة أسلاك النظام",
          desc: "المعايرة الكهربائية الاحترافية وتكامل العقد.",
        },
        appliance: {
          title: "تكامل الأجهزة",
          desc: "نشر واختبار الأجهزة الصحية والمطبخية.",
        },
        boiler: {
          title: "تدقيق الغلايات",
          desc: "الصيانة الحرارية التنظيمية وتشخيص الأداء.",
        },
        switch: {
          title: "المفاتيح الكهربائية",
          desc: "استبدال المكونات الكهربائية عالية التكامل.",
        },
        smart: {
          title: "الأتمتة الذكية",
          desc: "أتمتة المنزل عبر شبكة متداخلة ونشر المستشعرات.",
        },
      },
    },
    repairs: {
      hero: {
        ...
        title2: "صيانة عالية الجودة",
        subtitle:
          "من تجميع الأثاث إلى المعالجة الإنشائية. خبراء صيانة عالي الجودة مختارون بعناية في المملكة المتحدة تحت تصرفك.",
      ...
      sub_categories: {
        furniture: {
          title: "تجميع الأثاث",
          desc: "تجميع دقيق للأجهزة الموديلية المعقدة.",
        },
        structural: {
          title: "التركيبات الإنشائية",
          desc: "تركيب ومعايرة التركيبات عالية الأحمال.",
        },
        wall: {
          title: "ترميم الجدران",
          desc: "إصلاح السطح واستعادة الطلاء الإنشائي.",
        },
        mounting: {
          title: "التركيب المودبلي",
          desc: "النشر الآمن لوحدات الحائط الرقمية والفيزيائية.",
        },
        coating: { title: "الطلاء", desc: "معالجات السطح الجمالية والوقائية." },
        tactics: {
          title: "تكتيكات عامة",
          desc: "بروتوكولات الصيانة المنزلية للأغراض العامة.",
        },
      },
    },
    renovation: {
      hero: {
        ...
        subtitle:
          "حول عقارك مع خبراء تجديد عالي الجودة مختارون بعناية في المملكة المتحدة. تتبع شفاف ونتائج مضمونة الجودة.",
      ...
      sub_categories: {
        culinary: {
          title: "المطبخ والصحة",
          desc: "إعادة هندسة المطبخ والحمام بالكامل.",
        },
        expansion: {
          title: "وحدات التوسعة",
          desc: "توسعات العلية والوحدات لزيادة حجم العقار.",
        },
        layout: {
          title: "التنسيق المكاني",
          desc: "التصميم الهولوجرامي وإعادة التكوين الإنشائي.",
        },
        floor: {
          title: "تشبيك الأرضيات",
          desc: "نشر الأرضيات عالية المتانة والتشطيب.",
        },
        landscape: {
          title: "تنسيق المواقع",
          desc: "هندسة بيئة العقار الخارجية.",
        },
        design: {
          title: "سياق التصميم",
          desc: "المخططات المعمارية والمنطق الجمالي.",
        },
      },
    },
    accounting: {
      hero: {
        ...
        title2: "رأس المال",
        subtitle:
          "محاسبين عالي الجودة مختارون بعناية والمخططين الماليين في المملكة المتحدة للشركات الصغيرة والمتوسطة والمهنيين. ضمان الامتثال التشغيلي وتحسين الضرائب.",
      ...
      sub_categories: {
        income: {
          title: "تدقيق الدخل",
          desc: "التقييم الذاتي ومعايرة ضريبة الدخل الشخصي.",
        },
        accounts: {
          title: "الحسابات السنوية",
          desc: "التقارير المالية للشركات وإغلاق الدفاتر.",
        },
        tax: {
          title: "تقديم الضرائب",
          desc: "إعداد الضرائب الجاهزة لـ HMRC وإرسالها.",
        },
        payroll: {
          title: "تشبيك الرواتب",
          desc: "أنظمة دفع رأس المال البشري الفعالة.",
        },
        xero: {
          title: "تحسين Xero",
          desc: "تكامل المحاسبة السحابية والتدريب.",
        },
    ...
    legal: {
      hero: {
        ...
        subtitle:
          "تواصل مع خبراء قانونيين معتمدين في المملكة المتحدة لبروتوكولات التأشيرة وصياغة العقود ودعم تسوية المنازعات.",
      ...
      sub_categories: {
        drafting: {
          title: "صياغة SLA",
          desc: "تجميع العقود والاتفاقيات عالية الدقة.",
        },
        visa: {
          title: "معايرة التأشيرة",
          desc: "دعم بروتوكول التأشيرة والهجرة في المملكة المتحدة.",
        },
        property: {
          title: "أطر الملكية",
          desc: "الخدمات القانونية للعقارات والمنطق القانوني.",
        },
        arbitration: {
          title: "التحكيم",
          desc: "بروتوكولات تسوية المنازعات والوساطة المحايدة.",
        },
        law: { title: "قانون السوق", desc: "دعم الحوكمة المؤسسية والتجارية." },
        notary: {
          title: "كاتب عدل",
          desc: "التحقق من الوثائق الرسمية والمصادقة عليها.",
        },
      },
    },
    cleaning: {
      hero: {
        ...
        title2: "بيئتك",
        subtitle:
          "بروتوكولات تنظيف عالية الجودة للعقارات السكنية والتجارية. تطهير عالي التكامل واهتمام دقيق بالتفاصيل.",
        searchPlaceholder: "تنظيف عميق، نهاية عقد الإيجار...",
        searchBtn: "نشر المتخصصين",
      },
      sub_categories: {
        hygiene: {
          title: "النظافة المتكررة",
          desc: "تطهير الممتلكات المتكرر والمعياري.",
        },
        tenancy: {
          title: "نهاية الإيجار",
          desc: "تنظيف عميق لانتقالات الإشغال.",
        },
        textile: {
          title: "تنظيف المنسوجات",
          desc: "ترميم السجاد والمفروشات الاحترافي.",
        },
        aperture: {
          title: "تنظيف الفتحات",
          desc: "بروتوكولات تطهير النوافذ العالية والزجاج.",
        },
        office: {
          title: "تطهير المكاتب",
          desc: "إدارة النظافة لمناطق العمل التجارية.",
        },
        bio: {
          title: "الأمن الحيوي",
          desc: "إزالة التلوث والتطهير من الدرجة السريرية.",
        },
      },
    },
    car: {
      hero: {
        ...
        title2: "الدقيقة",
        subtitle:
          "حافظ على أجهزتك المحمولة مع ميكانيكا محترفين في المملكة المتحدة. تشخيصات في الموقع وخدمات عالية الأداء تحت تصرفك.",
      ...
      sub_categories: {
        engine: {
          title: "تشخيص المحرك",
          desc: "اكتشاف الأعطال المتقدم وضبط الأداء.",
        },
        brakes: {
          title: "الفرامل والقابض",
          desc: "معايرة نظام الاحتكاك الحرج للسلامة.",
        },
        mot: { title: "تحضير MOT", desc: "فحوصات التفتيش التنظيمية والعلاج." },
        ac: {
          title: "معايرة التكييف",
          desc: "إعادة تعبئة الغاز ونظافة نظام التحكم في المناخ.",
        },
        bodywork: {
          title: "ترميم الهيكل",
          desc: "معالجة الغلاف الإنشائي والجمالي.",
        },
        battery: {
          title: "الطاقة والإطارات",
          desc: "إدارة صحة البطارية وكثافة الإطارات.",
        },
      },
    },
    commercial: {
      hero: {
        ...
        title2: "عقدة عملك",
        subtitle:
          "دعم بنية تحتية شامل للمساحات التجارية في المملكة المتحدة. تجهيز المحلات، هجرة المكاتب، والصيانة الصناعية.",
      ...
      sub_categories: {
        fitting: {
          title: "تجهيز الوحدات",
          desc: "هندسة التصميم الداخلي للمساحات التجارية والتجزئة.",
        },
        relocation: {
          title: "نقل العقدة",
          desc: "بروتوكولات هجرة المكاتب والصناعية السلسة.",
        },
        industrial: {
          title: "الطاقة الصناعية",
          desc: "نشر شبكة الكهرباء عالية الجهد.",
        },
        fire: {
          title: "أمن الحريق",
          desc: "أنظمة شبكة السلامة والكشف التنظيمية.",
        },
  ...
  common: {
    ...
    escrow: {
      ...
      subtitle:
        "يتم مراقبة كل جلسة في قطاع {category} بواسطة الذكاء الاصطناعي لضمان الجودة والنزاهة المالية.",
  ...
  hero: {
    title: "ابحث عن خبراء خدمات عالي الجودة",
    subtitle: "نصلك بالمحترفين المعتمدين في منطقتك.",
    searchPlaceholder: "ما الخدمة التي تحتاجها؟",
    badge: "المنصة رقم 1 لحجز الخدمات في المملكة المتحدة",
  },
  faq: {
    ...
    aura: {
      title: "مساعد Aura AI",
      subtitle: "هل تحتاج مساعدة فورية؟ تحدث مع Aura للحصول على توصيات.",
      cta: "تحدث مع Aura",
    },
    questions: {
      payments: [
        {
          q: "كيف أقوم بالدفع مقابل الخدمة؟",
          a: "تتم معالجة المدفوعات بأمان عبر Stripe. نحتفظ بالأموال في حساب ضمان حتى تؤكد اكتمال العمل.",
        },
        {
          q: "هل هناك رسوم خفية؟",
          a: "لا. المنصة لا تتقاضى أي رسوم خدمة من العملاء. أنت تدفع فقط مقابل العمالة والمواد المعتمدة.",
        },
      ],
      disputes: [
        {
          q: "ماذا لو كان العمل غير مرضي؟",
          a: "يقوم محكمو الذكاء الاصطناعي لدينا بمراجعة الصور بناءً على نطاق العمل الأصلي لضمان حل عادل.",
        },
        {
          q: "كيف أطلب استرداد الأموال؟",
          a: "يمكنك فتح نزاع من خلال لوحة التحكم الخاصة بك إذا لم يلتزم الخبير بالشروط المتفق عليها.",
        },
      ],
      bookings: [
        {
          q: "هل يمكنني إلغاء الحجز؟",
          a: "نعم، يمكنك الإلغاء قبل 24 ساعة من الموعد المحدد لاسترداد المبلغ بالكامل.",
        },
        {
          q: "كيف أتواصل مع الخبير الخاص بي؟",
          a: "بمجرد تأكيد الحجز، ستتمكن من الوصول إلى قناة دردشة آمنة.",
        },
      ],
    },
  },
  aura: {
    welcome:
      "مرحباً! أنا Aura، منسق الخدمات الخاص بك في المملكة المتحدة. كيف يمكنني مساعدتك اليوم؟",
    offline: "غير متصل",
  ...
  footer: {
    tagline: "نصلك بالمحترفين عالي الجودة المختارين بعناية في المملكة المتحدة.",
    explore: "استكشف",
    legal: "قانوني",
    support: "الدعم",
    ...
    aboutUs:
      "ConciergeAI نصل أصحاب المنازل في المملكة المتحدة بـ خبراء خدمة عالي الجودة مختارون بعناية المعتمدين.",
    companyNo: "12345678",
    vatNo: "GB123456789",
    social: {
  ...
  search: {
    ...
    sortJobs: "الأكثر عملاً",
    sortDistance: "الأقرب",
    sortPrice: "السعر: من الأقل للأعلى",
    foundCount: "تم العثور على {{count}} محترف",
    searching: "جاري البحث عن خبراء...",
    noResults: "لم يتم العثور على خبراء يطابقون بحثك",
    noResultsHint: "حاول تعديل الفلاتر أو البحث في منطقة مختلفة.",
  ...
  booking: {
    ...
    titles: {
      details: "أخبرنا عن احتياجاتك",
      schedule: "اختر موعداً",
      confirm: "أكد حجزك",
    ...
    labels: {
      ...
      address: "العنوان",
      notes: "ملاحظات",
      agree: "أوافق على الشروط (رسوم منصة مجانية للعملاء)",
      summary: "ملخص الدفع",
      paid: "مدفوع",
      merchant: "الخبير",
      service: "الخدمة",
    ...
    messages: {
      finalizing: "جاري إنهاء حجزك...",
      wait: "يرجى عدم تحديث الصفحة",
      contact24h: "سيتصل بك الخبير خلال 24 ساعة.",
      safety: "لأمانك، يتم الاحتفاظ بجميع المدفوعات في حساب ضمان.",
      noReviews: "لا توجد تقييمات بعد",
      recommended: "موصى به بشدة",
      replyFromMaster: "رد من الخبير",
    },
  },
  merchant_dashboard: {
    ai_secretary: {
    ...
    background: "تم التحقق من الخلفية",
    portfolio: "معرض الأعمال",
    reviewTitle: "تقييمات العملاء",
    realReviews: "تقييمات حقيقية من حجوزات معتمدة",
    verifiedBooking: "حجز معتمد",
    pricingAnalysis: "تحليل الأسعار AI",
    bookingChannel: "قناة حجز احترافية",
    viewServices: "عرض كافة الخدمات",
    ...
    title: "لوحة تحكم التاجر",
      ...
      wallet: {
        ...
        referralDesc:
          "شارك كودك الفريد. ستحصل على 2% في شكل قسائم إلكترونية للمتاجر والسوبر ماركت عند حجز صديقك لخدمته الأولى.",
        ...
        rewards: {
          ...
          subtitle:
            "* استبدال غير نقدي. قسائم لمتاجر التجزئة الكبرى (Tesco, Amazon). يتم المعالجة خلال 24 ساعة.",
          myVault: "محفظتي",
          redeemBtn: "تبديل",
          ...
          confirmRedeem:
            "هل أنت متأكد من رغبتك في تبديل المكافأة؟ سيتم الإصدار خلال 24 ساعة.",
          requestSuccess:
            "تم الطلب بنجاح! جاري تخصيص كودك. يرجى التحقق من محفظتك لاحقاً.",
        },
      },
      bookings: {
        title: "الحجوزات الأخيرة",
        viewAll: "عرض الكل",
        empty: "لا توجد حجوزات أخيرة",
        completed: "مكتمل",
        actions: {
          confirm: "تأكيد",
          complete: "تحديد كمكتمل",
          variation: "طلب دفع إضافي",
        },
      },
      status: {
      ...
      variations: {
        label: "تغيير السعر",
        status: "الحالة",
        pending: "في انتظار العميل",
        approved: "تمت الموافقة",
        rejected: "مرفوض",
        arbiterActive: "تحكيم AI نشط",
      },
      arbiterReasoning: "تحليل التحكيم AI",
      tips: {
        title: "نصائح النمو",
        growth:
          "حافظ على جودة خدمة عالية لضمان الظهور كمحترف عالي الجودة واستمرارية المهام.",
      },
      quickLinks: {
        title: "روابط سريعة",
        schedule: "الجدول",
      ...
      modal: {
        title: "طلب دفع إضافي",
        amount: "المبلغ الإضافي (£)",
        reason: "السبب",
        reasonPlaceholder: "مثلاً: تسريب إضافي تحت الأرضية",
        photo: "دليل صوري",
        photoHint: "مطلوب للتحقق بواسطة AI",
        submit: "إرسال الطلب",
        submitting: "جاري الرفع...",
      },
      avatar: {
        upload: "رفع صورة",
        hint: "يفضل صورة احترافية أو شعار الشركة.",
        success: "تم تحديث الصورة!",
        errorSize: "يجب أن يكون الحجم أقل من 2 ميجابايت",
      },
      accounting: {
        title: "المحاسبة والضرائب",
        subtitle:
          "مركز مالي أوتوماتيكي في المملكة المتحدة: مراقبة ضريبة القيمة المضافة وتوقعات الضرائب.",
        ...
        taxPayableDesc:
          "محسوبة بناءً على شرائح ضريبة الدخل في المملكة المتحدة لعام 24/25.",
        ...
        upgradeDesc:
          "الدفاتر المحاسبية الآلية، ملخصات سنة الضرائب، وتصدير بيانات CSV.",
    ...
    portfolio_mgr: {
      ...
      emptyDesc: "أضف صوراً لمشاريعك السابقة لبناء الثقة.",
      modal: {
        title: "إضافة عمل",
        itemTitle: "العنوان",
        itemTitlePlaceholder: "مثلاً: تركيب غلاية في لندن",
        category: "الفئة",
        uploadPhoto: "رفع صور المشروع",
        errorSize: "يجب أن يكون الحجم أقل من 5 ميجابايت",
        details: "التفاصيل",
        aiBtn: "توليد بالذكاء الاصطناعي",
        aiGenerating: "جاري الكتابة...",
        detailsPlaceholder: "صف العمل الذي قمت به والنتائج.",
        cancel: "إلغاء",
        publish: "نشر",
      },
      deleteConfirm: "هل أنت متأكد من حذف هذا العمل؟",
      addError: "فشل الإضافة.",
      aiError: "فشل AI، يرجى الإدخال يدوياً.",
    },
  },
  education_sec: {
    hero: {
      badge: "مدرسي المملكة المتحدة عالي الجودة المختارين بعناية",
      title1: "أتقن مهارات جديدة",
      title2: "مع كبار الخبراء",
      subtitle:
        "تواصل مع مدرسي عالي الجودة للأكاديميين واللغات والمهارات المهنية. تعلم خاص مصمم لنجاحك.",
      searchPlaceholder: "ماذا تريد أن تتعلم؟",
      searchBtn: "ابحث عن مدرس",
    },
    forYou: {
      title: "توصيات لك",
      match: "مطابقة AI",
    ...
    search: {
      ...
      offline: "حضوري",
      hybrid: "هجين",
      priceRange: "نطاق السعر (ساعة)",
      level: "المستوى",
      student: "طالب جامعي",
      pro: "مدرس محترف",
      expert: "خبير (ماجستير/دكتوراه)",
      apply: "تطبيق",
      resultsTitle: "المدرسون المتاحون",
      foundCount: "تم العثور على {{count}} مدرس",
      placeholder: "ابحث عن مادة أو اسم",
    },
    common: { reviews: "تقييمات", hr: "ساعة", bookTrial: "حجز حصة تجريبية" },
    tutorCard: {
      demoDesc:
        "مدرس شغوف حاصل على دكتوراه مع خبرة تزيد عن 10 سنوات، ساعد أكثر من 100 طالب في تحقيق أهدافهم.",
    },
    tutorProfile: {
      verified: "مدرس معتمد",
      about: "عن المدرس",
      education: "التعليم",
      experience: "الخبرة",
      portfolio: "قصص نجاح الطلاب",
      reviews: "تقييمات الطلاب",
      availability: "الجدول الأسبوعي",
      bookNow: "احجز الآن",
      aiTrial: "تقييم AI",
      trialChallenge: "تحدي التشخيص الأكاديمي",
  ...
  home: {
    hero: {
      badge: "محترفون محليون معتمدون",
      title1: "احجز أفضل",
      title2: "الخبراء المحليين",
      subtitle:
        "وصول فوري إلى المتخصصين عالي الجودة المختارين بعناية في المملكة المتحدة. جميعهم معتمدون ومؤمن عليهم ومراقبون بواسطة AI.",
      searchPlaceholder: "أنا أحتاج...",
      locationPlaceholder: "لندن، المملكة المتحدة",
      aiMatch: "مطابقة ذكية",
      searchBtn: "بحث الاتصال",
      suggestions: [
    ...
    recommendation: {
      title1: "موصى به",
      title2: "لك",
      subtitle: "أفضل المحترفين بناءً على احتياجاتك وموقعك الحالي.",
      browse: "عرض الكل",
    },
    ...
    aiCTA: {
      badge: "مدعوم بواسطة ChatGPT, Gemini & Grok",
      title1: "لا تعرف ما المشكلة؟",
      title2: "احصل على تشخيص AI فوري",
      subtitle:
        "ارفع صورة للمشكلة. سيتعرف الذكاء الاصطناعي على العطل ويقدر التكلفة ويجد لك الخبير المناسب في ثوانٍ.",
      button: "ابدأ التشخيص المجاني",
    },
    referralCTA: {
      badge: "مكافآت الترشيح",
      title: "اكسب 2% دخل سلبي",
      subtitle:
        "رشح أصدقاءك واحصل على 2% من جميع حجوزاتهم للسنوات الخمس القادمة في شكل قسائم تسوق (غير قابلة للسحب النقدي).",
      button: "ابدأ الكسب الآن",
      referralLabel: "كود الترشيح الخاص بك:",
      voucherDisclaimer:
        "* المكافآت قابلة للاستبدال كقسائم فقط. لا يوجد سحب نقدي.",
    },
    ...
    sections: {
      plumbing: {
        title: "السباكة والخدمات الفنية",
        desc: "من التسريبات الطارئة إلى الأسلاك المعقدة، نصلك بفنيين معتمدين.",
        items: [
          "إصلاح التسريب",
          "كهرباء",
          "تركيب أجهزة",
      ...
      repairs: {
        ...
        desc: "تجميع الأثاث، إصلاح الجدران، تغيير الأقفال - كل مهام المنزل.",
        items: [
          "تجميع أثاث",
          "نجارة",
          "ترميم جدران",
      ...
      accounting: {
        title: "المحاسبة والضرائب",
        desc: "مخصص للطلاب والشركات الصغيرة. ابقَ متوافقاً مع الضرائب.",
        items: [
          "إقرار ضريبي",
          "حسابات سنوية",
      ...
      renovation: {
        ...
        desc: "من توسعات المطابخ إلى التجديد الشامل. إدارة شفافة وجودة مضمونة.",
        items: [
          "مطابخ وحمامات",
          "توسعة منزل",
          "تصميم داخلي",
      ...
      education: {
        ...
        desc: "مدرسون ومدربون محترفون. خطط تعلم مخصصة.",
        items: [
          "مدرسو لغات",
          "IELTS/TOEFL",
          "برمجة",
      ...
      cleaning: {
        title: "تنظيف احترافي",
        desc: "تنظيف عميق عند انتهاء الإيجار أو تنظيف منزلي دوري دقيق.",
        items: [
          "تنظيف دوري",
          "تنظيف انتهاء عقد",
          "غسيل سجاد",
      ...
      legal: {
        ...
        desc: "طلبات التأشيرة، صياغة العقود وغيرها. تواصل مع خبراء لحماية حقوقك.",
        items: [
          "صياغة عقود",
          "تأشيرات",
          "قانون العقارات",
      ...
      commercial: {
        ...
        desc: "للمساحات التجارية. تجهيزات المتاجر، نقل المكاتب وصيانة الكهرباء.",
        items: [
          "تجهيز محلات",
          "نقل مكاتب",
          "كهرباء صناعية",
    ...
    popularTitle: "رائج",
    popularIn: "في",
    allUK: "كل المملكة المتحدة",
    noProjects: {
      title: "لا توجد مشاريع في هذه الفئة",
      desc: "نحن نقوم بنشاط بضم كبار الخبراء في منطقتك.",
    },
    reviews: {
      excellent: "ممتاز",
      basedOn: "بناءً على",
    ...
    howItWorks: {
      title: "كيف يعمل",
      subtitle:
        "بروتوكول حجز الخدمات الأكثر تقدمًا في المملكة المتحدة، مدعومًا بالذكاء الاصطناعي.",
      step1Title: "تشخيص AI",
      step1Desc:
        "قم بتحميل المشكلات لتحديد الأعطال الفورية وتقدير التكلفة الدقيقة.",
      step2Title: "المطابقة الذكية",
      step2Desc: "تحدد شبكتنا أفضل 1% من المتخصصين المعايرين لمشكلتك المحددة.",
      step3Title: "أمان الضمان",
      step3Desc:
        "يتم الاحتفاظ بالمدفوعات في حساب ضمان آمن حتى تؤكد نجاح العملية.",
      step4Title: "ضمان الخدمة",
      step4Desc:
        "تتم مراقبة كل جلسة بواسطة الذكاء الاصطناعي لضمان الجودة ودعم حل النزاعات.",
    },
  },
  location: {
  ...
  diagnosis: {
    ...
    title2: "بسرعة البرق",
    subtitle:
      "توقف عن التخمين. يحلل الذكاء الاصطناعي صورك لتقديم رؤى فورية ونطاق إصلاح وتقديرات تكلفة عادلة قبل الحجز.",
    features: {
      instant: {
        title: "رؤى فورية",
        desc: "لا داعي لانتظار المكالمات. احصل على تحليل تقني فور رفع الصورة.",
      },
      pricing: {
        title: "أسعار عادلة",
        desc: "نستخدم بيانات الخدمة الحقيقية لتقديم نطاق تكلفة دقيق لمنطقتك.",
      },
      verified: {
        title: "حجز معتمد",
        desc: "بعد التشخيص، تواصل مباشرة مع أفضل 1% من الخبراء المناسبين لمشكلتك.",
      },
    },
    cta: "تصفح كل الخدمات",
    tool: {
      ...
      authRequired:
        "للأعضاء فقط: يرجى تسجيل الدخول لاستخدام تشخيص الذكاء الاصطناعي",
      limitReached: "تم الوصول إلى الحد اليومي (5/5)",
      limitReachedHint:
        "يمكنك الاتصال بخبرائنا الموصى بهم مباشرة أو المحاولة مرة أخرى غدًا.",
  ...
  onboarding: {
    hero: {
      title: "وسع أعمالك مع ConciergeAI",
      subtitle:
        "انضم إلى شبكة النخبة من خبراء الخدمة المعتمدين في المملكة المتحدة.",
    },
    steps: {
      profile: "الملف العملي",
      credentials: "الاعتمادات",
      contract: "اتفاقية الخدمة",
    },
    sectors: {
      title: "اختر قطاعك العملي",
      professional: {
        title: "خدمات احترافية",
        desc: "محاسبة، قانون، استشارات",
        industries: ["محاسب", "خبير ضرائب", "قانوني", "استراتيجي"],
      },
      education: {
        title: "مشاريع تعليمية",
        desc: "مدرسون، مدربون",
        industries: ["مدرس أكاديمي", "مدرب لغات", "مدرب مهارات", "مدرس موسيقى"],
      },
      technical: {
        title: "خدمات تقنية",
        desc: "حرفيون، صيانة، هندسة",
        industries: ["سباك", "كهربائي", "ميكانيكي", "مرمم منازل"],
      },
    },
    contract: {
      title: "اتفاقية الخدمة الموحدة",
      scrollingNotice: "يرجى التمرير للنهاية للموافقة بك الشروط.",
      agree: "لقد قرأت وأوافق على اتفاقية ConciergeAI الرئيسية.",
      clauses: {
        platform_fee: {
          title: "1. رسوم الخدمة",
        ...
        payments: {
          ...
          body: "توضع دفعات العملاء في حساب ضمان آمن. يتم تحرير السيولة بعد 48 ساعة من تأكيد اكتمال المهمة.",
        },
        conduct: {
          title: "3. معايير السلوك المهني",
  ...
  admin: {
    ...
    analytics: {
      gmvTitle: "GMV",
      gmvSub: "تحليلات الإيرادات",
      sectorDist: "توزيع القطاعات",
      volTitle: "حجم السوق",
      live: "مباشر",
    },
    bookings: {
    ...
    users: {
      title: "المستخدمين",
      sub: "قاعدة بيانات المستخدمين",
      stats: "الإحصائيات",
      registeredAt: "انضم في",
      referrals: "الإحالات",
    },
    commissions: {
      title: "العمولات",
      sub: "التحكم في الإيرادات",
      plateformFee: "رسوم المنصة",
      marketplaceFee: "رسوم السوق",
      adminControl: "تحكم المسؤول",
      weightedAvg: "المتوسط المرجح",
      totalJobs: "إجمالي الوظائف",
      deliveryVolume: "حجم التسليم",
      merchantDetails: "تفاصيل التاجر",
    },
    disputes_mgr: {
      empty: "لا توجد نزاعات معلقة.",
      viewDetails: "مراجعة",
      status: {
        open: "مفتوح",
    ...
    merchants_mgr: {
      empty: "لم يتم العثور على خبراء.",
      status: { active: "نشط", suspended: "معلق", pending: "قيد الانتظار" },
    },
    settings_mgr: {
      ...
      fields: {
        companyName: "اسم العمل",
        aboutUs: "المهمة",
        logoUrl: "رابط الشعار",
        officeAddress: "العنوان",
        contactPhone: "الهاتف",
        contactEmail: "البريد الإلكتروني",
        companyRegistration: "رقم التسجيل",
  ...
  merchant_public: {
    ...
    about_title: "حول التاجر",
    about_fallback: "مزود خدمة محترف مخصص للنتائج عالية الجودة. تضمن الخبرة الواسعة والشهادات المهنية أعلى مستوى من الرضا لكل عميل.",
    services_title: "الخدمات",
    services_provided: "الخدمات المقدمة",
    your_search: "بحثك",
    customer_reviews: "مراجعات العملاء ({count})",
    write_review: "كتابة مراجعة",
    review_summary_title: "ملخص تحليل الذكاء الاصطناعي",
    review_summary_content: "يشيد العملاء باستمرار بالجودة العالية والكفاءة في العمل، مع ملاحظة التواصل الممتاز والمواظبة على المواعيد والالتزام بالنظافة بعد الانتهاء.",
    review_summary_note: "✦ تم إنشاؤه بواسطة الذكاء الاصطناعي من مراجعات العملاء. ConciergeAI ليست مسؤولة عن محتوى الملخص.",
    no_reviews: "لا توجد مراجعات بعد",
    consultation_title: "الاستشارة",
    book_now: "احجز الخدمة الآن",
    send_message: "إرسال رسالة",
    call_now: "اتصل مباشرة ({phone})",
    platform_tip: "نصيحة أمنية: نلزم بالتواصل من خلال دردشة ConciergeAI الداخلية لضمان سلامتك وضمان الرضا بنسبة 100%.",
    owner: "المالك",
    operates_in: "تعمل في",
    nationwide: "على مستوى البلاد",
    business_type: "نوع العمل",
    vat_registered: "مسجل في ضريبة القيمة المضافة",
    insurance: "التأمين",
    insured_amount: "£{amount} مؤمن",
    not_provided: "اتصل للمعلومات",
    yes: "نعم",
    no: "لا",
    nearby: "والمناطق المحيطة",
    quality: "جودة العمل",
    reliability: "الموثوقية",
    communication: "التواصل",
    review_overview: "بناءً على المراجعات خلال 12 شهرًا الماضية"
  },
  auth: {
    login: {
      title: "تسجيل الدخول",
