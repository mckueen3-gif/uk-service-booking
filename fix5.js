...
const koIdx = contentLines.findIndex(x => x.includes('ko: {'));
const plIdx = contentLines.findIndex(x => x.includes('pl: {'));
...
if (koIdx > -1 && plIdx > -1) {
  ...
  console.log('Fixed KO and RO dictionary blocks safely!');
} else {
  console.log('Failure!');
}
