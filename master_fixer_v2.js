...
function getDashboard(lang, aiSec) {
  const common = {
  ...
  return `{
    ...
    tools: {
      ...
      diagnosis: { name: "AI Diagnosis", badge: "FREE" },
      whatsapp: { name: "WhatsApp", badge: "FREE" },
      seo: { name: "SEO", badge: "FREE" },
      ad_copy: { name: "AI Ad Copy", badge: "FREE" },
      video: { name: "Elite Video", badge: "FREE" }
    }
  }`;
}

fixFile('src/lib/i18n/locales/en.ts', { 'merchant_dashboard': getDashboard('en', aiSecretaryEN) });
fixFile('src/lib/i18n/locales/zh-TW.ts', { 'merchant_dashboard': getDashboard('zh-TW', aiSecretaryZH) });
fixFile('src/lib/i18n/locales/ja.ts', { 'merchant_dashboard': getDashboard('ja', aiSecretaryJA) });
fixFile('src/lib/i18n/locales/ko.ts', { 'merchant_dashboard': getDashboard('ko', aiSecretaryKO) });
